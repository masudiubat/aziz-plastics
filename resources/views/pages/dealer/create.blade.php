...
<a href="#" class="kt-subheader__breadcrumbs-link"> Create Dealer </a>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{route('dealer.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="kt-portlet__body" style="padding:5px 15px;">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <select id="sdsm" name="sdsm" class="form-control @error('sdsm') is-invalid @enderror">
                                    <option value="">Select SDSM</option>
                                    @if(!is_null($sdsms))
                                    @foreach($sdsms as $sdsm)
                                    <option value="{{$sdsm->id}}">{{$sdsm->name}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="dealer_name" id="dealerName" value="{{old('dealer_name')}}" class="form-control" placeholder="Dealer Name">
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <label>Phone:</label>
                                <input type="text" name="phone" value="{{old('phone')}}" id="phone" class="form-control" placeholder="Phone">
                            </div>
                        </div>
