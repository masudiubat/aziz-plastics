...
<a href="#" class="kt-subheader__breadcrumbs-link"> Edit Product </a>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{route('product.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="kt-portlet__body" style="padding:5px 15px;">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="name" value="{{ $product->name }}" id="name" class="form-control" placeholder="Enter Official Name">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <label>Weight:</label>
                                <input type="text" name="weight" value="{{ $product->weight }}" id="weight" class="form-control" placeholder="Weight">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="discount" value="{{ $product->discount }}" id="discount" class="form-control" placeholder="Discount in Percent">
                            </div>
                            <div class="col-lg-4">
                                <label class="">Net Price:</label>
                                <input type="text" name="net_price" value="{{ $product->net_price }}" id="net_price" class="form-control" placeholder="Net Price">
                            </div>
                        </div>
                    </div>
