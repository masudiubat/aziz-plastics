...
<div class="kt-container kt-container--fluid kt-grid__item kt-grid__item--fluid">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a href="#" class="btn btn-brand btn-elevate btn-icon-sm" data-toggle="modal" data-target="#new_user">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="event.preventDefault(); changeUserPassword('{{ $user->id }}');" href="#" title="Change Password" data-placement="top" data-toggle="tooltip" data-original-title="Change Password" class="btn btn-xs tooltips btn-clean">
                                <i class="la la-key"></i>
                            </a>

                            <a href="#" onclick="event.preventDefault(); deleteUser('{{$user->id}}');" title="Delete User" data-placement="top" data-toggle="tooltip" data-original-title="Delete User" class="btn btn-xs tooltips btn-clean">
    ...
    <div class="modal fade" id="new_user" tabindex="-1" role="dialog" aria-labelledby="newUserModalLabel" aria-hidden="true">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select id="designation" name="designation" class="form-control @error('designation') is-invalid @enderror" required>
                                            ...
                                            <option value="{{$designation->id}}">{{$designation->short_name}} - {{$designation->name}}</option>
                                            @endif
                                            @endforeach
                                            @endif
                                        </select>
